...
@implementation NSObject (NYTSwipeView)

- (CGSize)swipeViewItemSize:(__unused NYTSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused NYTSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused NYTSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused NYTSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused NYTSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused NYTSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused NYTSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused NYTSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused NYTSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused NYTSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface NYTSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<NYTSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<NYTSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(NYTSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case NYTSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case NYTSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == NYTSwipeViewAlignmentCenter)
        {
